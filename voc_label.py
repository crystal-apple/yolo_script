...
sets=[('2007', 'train'), ('2007', 'test'),('2007','trainval'),('2007','val')]
...
for year, image_set in sets:
    if not os.path.exists('/home/data/VOC%s/labels/'%(year)):
        os.makedirs('/home/data/VOC%s/labels/'%(year))
    ...
    for image_id in image_ids:
        list_file.write('/home/data/VOC%s/JPEGImages/%s.jpg\n'%(year, image_id))
        convert_annotation(year, image_id)
    list_file.close()

# os.system("cat 2007_train.txt 2007_val.txt 2012_train.txt 2012_val.txt > train.txt")
# os.system("cat 2007_train.txt 2007_val.txt 2007_test.txt 2012_train.txt 2012_val.txt > train.all.txt")
os.system("cat 2007_train.txt 2007_trainval.txt > ../train.txt")
